    ...
    <div>
      <div className="cal_container">
        ...
        <div className="cal_content">
          {/* NAV - LEFT */}
          <div className="cal_nav_left">
            <ArrowIcon.Left
              className="cal_nav_arrow_left"
          ...
          <Swiper
            ...
            slidesPerView={7}
            onSwiper={setSlider}
            className="cal_slider_content"
          >
            {slots.map((e, k) => (
              <SwiperSlide key={k}>
                <div className="cal_slider_slots">
                  <p>{e.name}</p>
                  <span>{e.day}</span>
                </div>
              </SwiperSlide>
          ...
          {/* NAV - RIGHT */}
          <div className="cal_nav_right">
            <ArrowIcon.Right
              className="calendar_head_arrow"
